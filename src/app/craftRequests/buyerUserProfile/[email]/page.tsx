...
const page = ({ params }: { params: Params }) => {
    ...
    const { data: buyerUserProfile = [], isLoading } = useQuery({
        queryKey: ["buyerUserProfile", params.email],
        queryFn: async () => {
    ...
    const { name, email, role, location, contactNumber, image } = buyerUserProfile || {}
